...
bool ADC::quick_setup(bool i_bInterruptEnable){
    ...
    //CTL0 Config
    ADC14->CTL0 = ADC14_CTL0_SHP | ADC14_CTL0_SHT0_0 | ADC14_CTL0_ON | ADC14_CTL0_SSEL__MCLK | ADC14_CTL0_DIV_2; //Sample and hold settings, turn on ADC and multiple samples
    //should add up to 44 kHz.
    if(m_vpPorts.size()>1) ADC14->CTL0 |= ADC14_CTL0_CONSEQ_3; // If more than one, consecrutive samples //This will fail.
    else ADC14->CTL0 |= ADC14_CTL0_CONSEQ_0;
    //CTL1 Config
